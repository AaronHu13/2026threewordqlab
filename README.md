...
| Act 7 晚安承天寺 | 11 | 按导演 2026-09-15 的 cts.qlab5 复刻：报幕 + 5 条音频（intro / 二胡 / 信 / 邮箱 / wake up，后四条 -5 dB）+ 二胡、信 5s 淡出、邮箱立刻停、wake up 5s 推高到 +12 dB；另加一条 wake up 手动淡出。导演未引用的 13 条 wav 放在 `未编排音频（导演工程未引用）/`，原工程在 `协作者草稿/cts.qlab5`（它要求音频在 `audio/` 子文件夹，直接开会红） |
