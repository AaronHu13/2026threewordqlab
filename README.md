...
Act 5_ 大堡健/
Act 6_ 最后的太阳/
Act 7_ 晚安承天寺/            # 2026-09-15 音频到位（18 条 wav），顺序待剧组确认；协作者草稿/cts.qlab5 是对方给的空骨架
Act 8_ 一幕成名2幕中无人/
...
| 幕 | cue 数 | 说明 |
|---|---|---|
| Act 1 回来了 | 7 | 报幕 + 6 条音效，顺序播 |
| Act 2 这个童话不对劲 | 26 | 报幕 + 11 条音效 + 11 条旁白。**没有拿到 cue 表**，音效按文件编号顺序、旁白按剧情插在 10 小矮人家 / 11 吃苹果前后，1 魔幻森林 / 4 皇后 intro / 6 狼人杀 各配一条手动淡出。顺序需要剧组确认，改 json 重建即可 |
| Act 3 今天小神有点忙 | 18 | 报幕 + 17 条，cue 13/14 音量 +3.5 dB |
| Act 4 卡巴莱特新编 | 13 | 报幕 + 12 条 |
| Act 5 大堡健 | 20 | 报幕 + 17 条音效 + 2 条淡出 |
| Act 6 最后的太阳 | 35 | 2026-09-15 按新音频包 + `requirements.txt` 重建：报幕 + 21 条音效，含 9+10 一键同停、12+13 一键同起、cue 8 / cue 18 播放中压低 30%-40% 的 D 类 fade。Cue 13 换 mp3、Cue 15 剪掉 1-2-3 倒数（原版在 `原始素材/`）、Cue 16 换 35.8s 新版 |
| Act 7 晚安承天寺 | 27 | 报幕 + 18 条 wav（按文件名编号顺序，长于 60s 的配手动淡出）。**没有 cue 表**：协作者给的 `协作者草稿/cts.qlab5` 只有 5 条未指向文件的 Audio cue，无法据此排序；wav 编号有重复且多份内容完全相同（见各 cue notes）。顺序需剧组确认后改 json 重建 |
| Act 8 一幕成名2幕中无人 | 68 | 报幕 + 67 条（2026-09-13 重建） |
