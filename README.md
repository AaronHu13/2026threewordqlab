...
| Act 4 卡巴莱特新编 | 16 | 报幕 + 12 条；1 In car（3s）/ 9 long新闻（2s）/ 12 kickline（8s）各配一条手动淡出（1 / 12 的时长是 2026-09-17 码戏剧组要求，12 的 8s 可能还会调）。**9 剧组说手里有 4 版候选、四选一，09-17 晚定稿后删掉另外三版；仓库目前只有一版，等剧组发定稿再换** |
